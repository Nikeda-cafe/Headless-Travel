<template lang="">
    <div class="container">
        ...
        <table>
            ...
            <tr>
                <th>Memo</th>
                <td><textarea name="content" class="content" id="" cols="50" rows="5" v-model="content"></textarea></td>
            </tr>
            <tr>
                <th></th>
                <td>
...
<script>
    export default {
        ...
        methods: {
            ...
            insert: function(){
                this.$store.commit('memo/insert',{title:this.title, contetnt:this.contetnt});
                this.title = '';
                this.content = '';
            },
