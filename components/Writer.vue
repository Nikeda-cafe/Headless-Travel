    ...
    <div class="bg-white dark:bg-gray-800 w-full shadow-lg mx-auto rounded-xl p-4">
        ...
        <div class="flex items-center my-4 flex-wrap">
            ...
            <a href="https://github.com/Nikeda-cafe/Headless-Travel" target="_blank" class="s__writer__sns--button">
                <button type="button"  class=" py-2 px-4 flex items-center bg-gray-600 hover:bg-gray-700 focus:ring-gray-500 focus:ring-offset-gray-200 text-white transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
        ...
        <p class="text-gray-600 dark:text-white text-lg">
            ...
            東京理科大学卒。学生時代世界史が好きすぎて、歴史能力検定二級を取得。
